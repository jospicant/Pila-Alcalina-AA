  ...
  t_1sg = hanPasadoXms(muestreo_1sg,&tiempoAnterior,&tiempoActual);    //Miro si ha pasado un segundo
    ...
    if(t_1sg){                                                      //Si ha pasado 1 segundo
      ...
      acumulaLosDatos();                                               //acumulo los datos para hacer media luego
        ...
        if( tensionPilaActual > tensionMinima){                           // Si tengo una tensión  mayor de 0.8 V continuo midiendo y enviado a ThngSpeak
...
void plantillaOLED(){
    ...
    display.setCursor(0,15);display.println("Volts: ");display.setCursor(50,15);display.println(tensionPilaActual);
    display.setCursor(0,25);display.println("mA: ");display.setCursor(50,25);display.println(corrienteActual);
